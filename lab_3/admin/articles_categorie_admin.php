            ...
            <div class="container">
                <div class="row">
                    <section class="content__left col-md-10">
                        <div class="block">
                            <h3>Все записи</h3>
                            <form name="sort" action="articles_categorie_admin.php?categorie_id=<?php echo (int)$_GET['categorie_id']; ?>" method="post">
                                <select name="order">
                            ...
                            <div class="block__content">
                                ...
                                <?php
                                    if ($articles_exist) {
                                        ...
                                        if ($page > 1) {
                                            echo '<a href="articles_categorie_admin.php?page=' . ($page - 1) . '">&laquo; Прошлая страница</a>  ';
                                        }

                                        if ($page < $total_pages & $page > 1) {
                                            echo '<a href="articles_categorie_admin.php?page=' . ($page + 1) . '">Следующая страница &raquo;</a>';
                                        }
                                        echo '</div>';
                                    }
                                ?>
